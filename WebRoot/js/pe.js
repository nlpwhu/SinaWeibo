 ...
 * 正能量分析
 */
function PositiveEnergyAnalysis(idx, oriData){
	/*		获取正能量本体的数据		*/
	var pe = FatchPositiveEnergyNoumenon(idx, oriData);
...
{
	positiveEnergyStatistics(oriData);
	positiveEnergyTrend(oriData);
	positiveEnergyCloud(oriData);
}

function positiveEnergyStatistics(oriData) {
	PositiveEnergyAnalysis(0, oriData);
}

function positiveEnergyTrend(oriData) {
	PositiveEnergyAnalysis(1, oriData);
}

function positiveEnergyCloud(oriData) {
	PositiveEnergyAnalysis(2, oriData);
